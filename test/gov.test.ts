...
describe('Gov Tests', () => {
  describe('Query', () => {
    ...
    test('query vote', async () => {
      await BaseTest.getClient().gov
        .queryVote(13, 'cosmos186qhtc62cf6ejlt3erw6zk28mgw8ne7gmthzkc')
        .then(res => {
          console.log(JSON.stringify(res));
        })
        .catch(error => {
    ...
    test('query deposit', async () => {
      await BaseTest.getClient().gov
        .queryDeposit(15, 'cosmos186qhtc62cf6ejlt3erw6zk28mgw8ne7gmthzkc')
        .then(res => {
          console.log(JSON.stringify(res));
        })
        .catch(error => {
          ...
          .submitProposal(
            {
              ...
              value:{ 
                title:'1111',
                description:'1111',
                recipient: 'cosmos186qhtc62cf6ejlt3erw6zk28mgw8ne7gmthzkc',
                amount: [{denom: 'ubig',amount: '100'}]
              }
            },
            initDeposit, 
            BaseTest.baseTx)
  ...
  describe('Vote', () => {
    test(
      ...
      async () => {
        await BaseTest.getClient().gov
          .vote(17, types.VoteOption.VOTE_OPTION_YES, BaseTest.baseTx)
          .then(res => {
            console.log(JSON.stringify(res));
          })
          .catch(error => {
